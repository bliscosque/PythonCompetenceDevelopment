import sys
from PySide6.QtWidgets import (QApplication, QWidget, QLabel, QMessageBox, QLineEdit, QPushButton)
    ...
    def searchAuthors(self):
        ...
        try:
            ...
            if self.author_edit.text() in authors:
                ...
                answer = QMessageBox.question(self, "Author Not Found","""<p>Author not found in catalogue.</p><p>Do you wish to continue?</p>""",QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No, QMessageBox.StandardButton.Yes)
