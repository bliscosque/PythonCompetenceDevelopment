import sys
import os
from PySide6.QtWidgets import (QApplication, QWidget, QLabel, QLineEdit, QPushButton, QCheckBox, QMessageBox)
from PySide6.QtGui import QFont, QPixmap
from PySide6.QtCore import Qt

import importlib
module=importlib.import_module("102-registration")
NewUserDialog=getattr(module,"NewUserDialog")
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        """Create and arrange widgets in the main window."""
        curPath=os.path.dirname(os.path.realpath(__file__))
        image = curPath+"/images/background_kingfisher.jpg"
