import sys
import os
from PySide6.QtWidgets import (QApplication, QDialog, QLabel, QPushButton, QLineEdit, QMessageBox)
...
class NewUserDialog(QDialog):
    ...
    def setUpWindow(self):
        ...
        user_image = curPath+"/images/new_user_icon.png"
    ...
    def confirmSignUp(self):
        ...
        if name_text == "" or pswd_text == "":
            ...
            curPath=os.path.dirname(os.path.realpath(__file__))
            with open(curPath+"/files/users.txt", "a+") as f:
                f.write("\n" + name_text + " ")
                f.write(pswd_text)
            self.close() 